# TianJi Love Day 012 Review Checklist

Purpose: manual safety checklist before publishing Day012 assets.
...
- Queue: `assets/marketing/publishing-queue/day-012-publishing-queue.csv`
- KPI template: `data/love-test-day-012-kpi-entry.csv`
...
No "replay proves the red flag" or "stop replying forever" framing: pass_pending_manual_review
No real chat screenshot, name, photo, birth data, or account data: pass_pending_manual_review
Repair framed as a question, not a guaranteed outcome: pass_pending_manual_review
...
```text
- This pack deliberately replaces replay with a self-editing question; reject any copy that frames replay as proof of a red flag or a comeback.
- Avoid "stop texting them" or "this is a sign" instruction patterns.
- Avoid presenting repair as a guaranteed reconciliation path.
