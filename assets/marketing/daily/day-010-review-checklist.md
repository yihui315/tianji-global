# TianJi Love Day 010 Review Checklist

Purpose: manual safety checklist before publishing Day010 assets and closing the weekly readiness loop.

## Scope

- Publishing date: 2026-06-27
- Theme: Pattern first, optimization second
- Pack: `assets/marketing/daily/day-010-publishing-pack.md`
- Queue: `assets/marketing/publishing-queue/day-010-publishing-queue.csv`
- KPI template: `data/love-test-day-010-kpi-entry.csv`
...
KPI review does not analyze placeholder-only rows: pass_pending_manual_review
CTA starts at /love-test or queue review: pass_pending_manual_review
```
