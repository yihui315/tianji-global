# TianJi Love — Next 30 Hooks Pool
...
- No fake testimonials, fake user counts, fake revenue, fake accuracy.
- No "they will come back", "they still love you", or reunion guarantee.
- No diagnosis, medical, financial, or legal certainty.
- No "send this exact text", "act tonight", or chase framing.
- No private chats, names, birth data, photos, or identifying detail.
- CTA points to `/love-test` first; result pages stay private by default.

## Rotation themes

```
T1 - What is he thinking now?
T2 - Should I take the initiative in ambiguity?
T3 - Will they come back after no contact?
T4 - Is this relationship worth continuing?
...
3. T3 — No contact is a fact, not a forecast. Notice what you are projecting onto it.
4. T4 — A relationship worth continuing is one you can describe on a calm afternoon.
5. T5 — A useful love test should make you calmer, not more dependent.
6. T1 — You cannot read their last seen. You can read your own pattern.
7. T2 — Taking the initiative starts with naming what you actually want.
8. T3 — Will they come back is the wrong first question. Start with what you need today.
9. T4 — Worth continuing is a choice you make, not a verdict you wait for.
10. T5 — Privacy is part of the product. A reading that exposes you is not helpful.
11. T1 — "What is he thinking" usually means "what should I do." Both deserve a slow answer.
12. T2 — You do not need a prediction. You need a pause before action.
13. T3 — No contact can become a story. The story is yours to edit, not theirs to confirm.
...
- T1, T2, T3, T4 each appear 5–7 times across 30 hooks; baseline T5 carries the safety frame.
- No hook promises reunion, prediction accuracy, or "the answer".
- Each hook is paired with a `/love-test` or `/relationship/new` CTA in the publishing pack; no hook stands alone.