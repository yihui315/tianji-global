...
const loveCopy: Record<AppLanguage, LoveCopy> = {
  en: {
    ...
    hero: {
      ...
      description:
        "Get clarity on the question you can't stop replaying. Start with a private free relationship reading, then ask one question or unlock depth only when the preview feels useful.",
      loveTestCta: 'Take Love Test',
      primaryCta: 'Get clarity now',
  ...
  zh: {
    ...
    hero: {
      ...
      titleLead: '把你反复想不明白的那段关系，交给天机解读一次。',
      titleAccent: '',
      description: '以星轨、关系与时机作为线索，先看见模式，再决定下一步。',
      primaryCta: '交给天机解读一次',
      secondaryCta: '问一个问题',
      tertiaryCta: '抽三张牌',
