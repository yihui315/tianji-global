...
export const SITE = {
  ...
  description:
    'Discover romantic patterns, emotional timing, and relationship compatibility through a private Tianji Love reading. AI-powered BaZi, astrology, and tarot for modern love.',
