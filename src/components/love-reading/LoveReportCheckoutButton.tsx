...
export function LoveReportCheckoutButton({
  ...
  return (
    <div className="grid gap-3">
      ...
      >
        {isLoading ? 'Opening checkout...' : `Unlock premium relationship report - ${LOVE_PREMIUM_REPORT_DISPLAY}`}
      </button>
      <p className="max-w-md text-xs leading-5 text-white/48">
        One-time Love Premium report. Checkout opens only when the test-mode payment gate is configured.
      </p>
