...
const copy = {
  en: {
    ...
    sections: [
      ...
      ['Cookies, consent, and security', 'Necessary storage supports authentication, language, security, and consent records. Optional analytics and advertising storage are disabled by default and can be changed or withdrawn through the Privacy settings control available on every page.'],
