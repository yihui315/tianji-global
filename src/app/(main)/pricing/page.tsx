  ...
  en: {
    ...
    funnelOptions: [
      ...
      },
      {
        ...
        price: '¥19.9',
        body: 'Unlock the complete private Love Reading report as a one-time purchase after the payment gate is approved.',
      },
    ],
  ...
  zh: {
    ...
    funnelOptions: [
      ...
      },
      {
        ...
        price: '¥19.9',
        body: '在付费 gate 获批后，单次解锁完整私密爱情报告；先看免费预览，再决定是否继续。',
      },
    ],
    planBadge: '更多人选择',
    monthly: {
