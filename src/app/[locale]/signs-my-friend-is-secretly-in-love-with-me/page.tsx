...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    locale,
    path: '/signs-my-friend-is-secretly-in-love-with-me',
    title: 'Is My Friend Secretly in Love With Me?',
    description: 'Sensing romantic feelings from your friend? Explore the signs that reveal when friendship crosses into love.',
    type: 'article',
...
const t = {
  en: {
    title: 'Is My Friend Secretly in Love With Me?',
    subtitle: 'Sensing romantic feelings from your friend? Explore the signs that reveal when friendship crosses into love.',
...
export default async function SignsmyfriendissecretlyinlovewithmePage({ params }: PageParams) {
  const { locale } = await params;
  ...
  const schema = articleSchema({
    ...
    url: `https://tianji.love/${locale}/signs-my-friend-is-secretly-in-love-with-me`,
    publishedTime: '2025-06-10T00:00:00Z',
    locale,
  });
