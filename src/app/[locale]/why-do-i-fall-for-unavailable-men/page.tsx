...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    locale,
    path: '/why-do-i-fall-for-unavailable-men',
    title: 'Why Do I Keep Falling for Unavailable Men?',
    description: 'Repeatedly attracted to emotionally unavailable partners? Discover the astrological patterns behind this cycle.',
    type: 'article',
...
const t = {
  en: {
    title: 'Why Do I Keep Falling for Unavailable Men?',
    subtitle: 'Repeatedly attracted to emotionally unavailable partners? Discover the astrological patterns behind this cycle.',
...
export default async function WhydoifallforunavailablemenPage({ params }: PageParams) {
  const { locale } = await params;
  ...
  const schema = articleSchema({
    ...
    url: `https://tianji.love/${locale}/why-do-i-fall-for-unavailable-men`,
    publishedTime: '2025-06-10T00:00:00Z',
    locale,
  });
