...
export default async function LocalizedTermsRedirect({ params, searchParams }: PageParams) {
  const { locale } = await params;
  if (!isSupportedLocale(locale)) notFound();
  // Destination locale is fixed at /legal/terms?lang=<locale>. Only the
  ...
  permanentRedirect(buildRedirectHref(`/legal/terms?lang=${lang}`, query));
}