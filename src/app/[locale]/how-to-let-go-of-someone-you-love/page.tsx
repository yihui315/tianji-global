...
const copy = {
  en: {
    title: 'How to Let Go of Someone You Love',
...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({ locale, path: '/how-to-let-go-of-someone-you-love', title: t.title, description: t.description });
}
