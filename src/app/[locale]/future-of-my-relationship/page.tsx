...
const copy = {
  en: {
    title: 'Future of My Relationship Free Reading',
    description: 'Curious about the future of your relationship? Get a free cosmic reading to see what lies ahead for you and your partner.',
    cta: 'Get My Free Reading',
    paidCta: 'Unlock Full Report — $4.99',
    howWorks: 'How it works',
    steps: ['Enter your birth details', 'Receive your personalized cosmic reading', 'Get clarity on your next best step'],
    faq: [
      ...
      { q: 'Is my information kept private?', a: 'Yes. All data is encrypted and never shared.' },
      { q: 'Can I get a full detailed report?', a: 'Yes. Upgrade to our Deep Love Report ($19.99) for a complete 8-module analysis.' },
    ],
  },
  'zh-CN': {
    title: '爱情关系解析',
    ...
    faq: [
      { q: '这个解读有多准确？', a: '我们的解读结合古老占卜系统与现代AI分析，结果个性化生成。' },
...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({ locale, path: '/future-of-my-relationship', title: t.title, description: t.description });
}
