...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    locale,
    path: '/how-to-deal-with-jealous-partner',
    title: 'How to Deal With a Jealous Partner',
    description: 'Dealing with jealousy in your relationship? Learn astrology-backed insights on triggers and how to address it.',
    type: 'article',
...
const t = {
  en: {
    title: 'How to Deal With a Jealous Partner',
    subtitle: 'Dealing with jealousy in your relationship? Learn astrology-backed insights on triggers and how to address it.',
...
export default async function todealwithjealouspartnerPage({ params }: PageParams) {
  const { locale } = await params;
  ...
  const schema = articleSchema({
    ...
    url: `https://tianji.love/${locale}/how-to-deal-with-jealous-partner`,
    publishedTime: '2025-06-10T00:00:00Z',
    locale,
  });
