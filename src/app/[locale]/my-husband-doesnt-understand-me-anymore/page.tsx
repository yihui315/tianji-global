...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    locale,
    path: '/my-husband-doesnt-understand-me-anymore',
    title: 'My Husband Do Not Understand Me Anymore',
    description: 'Feeling emotionally disconnected? Explore what the stars say about communication breakdowns in marriage.',
    type: 'article',
...
const t = {
  en: {
    title: 'My Husband Do Not Understand Me Anymore',
    subtitle: 'Feeling emotionally disconnected? Explore what the stars say about communication breakdowns in marriage.',
...
export default async function husbanddoesntunderstandmeanymorePage({ params }: PageParams) {
  const { locale } = await params;
  ...
  const schema = articleSchema({
    ...
    url: `https://tianji.love/${locale}/my-husband-doesnt-understand-me-anymore`,
    publishedTime: '2025-06-10T00:00:00Z',
    locale,
  });
