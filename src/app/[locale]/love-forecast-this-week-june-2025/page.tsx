...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    locale,
    path: '/love-forecast-this-week-june-2025',
    title: 'Love Forecast This Week — June 9–15, 2025',
    description: 'What does this week hold for your love life? Get your weekly love astrology forecast based on planetary transits.',
    type: 'article',
...
const t = {
  en: {
    title: 'Love Forecast This Week — June 9–15, 2025',
    subtitle: 'What does this week hold for your love life? Get your weekly love astrology forecast based on planetary transits.',
...
export default async function Loveforecastthisweekjune2025Page({ params }: PageParams) {
  const { locale } = await params;
  ...
  const schema = articleSchema({
    ...
    url: `https://tianji.love/${locale}/love-forecast-this-week-june-2025`,
    publishedTime: '2025-06-10T00:00:00Z',
    locale,
  });
