...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    locale,
    path: '/can-astrology-predict-my-marriage-timeline',
    title: 'Can Astrology Predict My Marriage Timeline?',
    description: 'Discover what astrology reveals about your marriage timing based on your birth chart, Venus placements, and 7th house indicators.',
    type: 'article',
...
const t = {
  en: {
    title: 'Can Astrology Predict My Marriage Timeline?',
    subtitle: 'Discover what astrology reveals about your marriage timing based on your birth chart, Venus placements, and 7th house indicators.',
...
export default async function CanastrologypredictmymarriagetimelinePage({ params }: PageParams) {
  const { locale } = await params;
  ...
  const schema = articleSchema({
    ...
    url: `https://tianji.love/${locale}/can-astrology-predict-my-marriage-timeline`,
    publishedTime: '2025-06-10T00:00:00Z',
    locale,
  });
