...
const copy = {
  en: {
    title: 'Is My Relationship Fate or Choice?',
...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({ locale, path: '/is-my-relationship-fate-or-choice', title: t.title, description: t.description });
}
