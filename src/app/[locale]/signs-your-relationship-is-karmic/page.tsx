...
const copy = {
  en: {
    title: 'Signs Your Relationship is Karmic',
...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({ locale, path: '/signs-your-relationship-is-karmic', title: t.title, description: t.description });
}
