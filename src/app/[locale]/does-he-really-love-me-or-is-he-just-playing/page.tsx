...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    locale,
    path: '/does-he-really-love-me-or-is-he-just-playing',
    title: 'Does He Really Love Me — Or Is He Just Playing?',
    description: 'Unsure if his feelings are genuine? Discover the signs that reveal whether he is truly in love or just playing.',
    type: 'article',
...
const t = {
  en: {
    title: 'Does He Really Love Me — Or Is He Just Playing?',
    subtitle: 'Unsure if his feelings are genuine? Discover the signs that reveal whether he is truly in love or just playing.',
...
export default async function hereallylovemeorishejustplayingPage({ params }: PageParams) {
  const { locale } = await params;
  ...
  const schema = articleSchema({
    ...
    url: `https://tianji.love/${locale}/does-he-really-love-me-or-is-he-just-playing`,
    publishedTime: '2025-06-10T00:00:00Z',
    locale,
  });
