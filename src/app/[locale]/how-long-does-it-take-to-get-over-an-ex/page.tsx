...
const copy = {
  en: {
    title: 'How Long Does It Take to Get Over an Ex?',
...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({ locale, path: '/how-long-does-it-take-to-get-over-an-ex', title: t.title, description: t.description });
}
