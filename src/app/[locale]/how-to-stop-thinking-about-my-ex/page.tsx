...
const copy = {
  en: {
    title: 'How to Stop Thinking About My Ex',
...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({ locale, path: '/how-to-stop-thinking-about-my-ex', title: t.title, description: t.description });
}
