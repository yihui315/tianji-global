...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    locale,
    path: '/how-to-know-if-my-ex-is-over-me',
    title: 'How to Know If My Ex Is Actually Over Me',
    description: 'Wondering if your ex has moved on? Discover the behavioral and astrological signs that reveal the truth.',
    type: 'article',
...
const t = {
  en: {
    title: 'How to Know If My Ex Is Actually Over Me',
    subtitle: 'Wondering if your ex has moved on? Discover the behavioral and astrological signs that reveal the truth.',
...
export default async function toknowifmyexisovermePage({ params }: PageParams) {
  const { locale } = await params;
  ...
  const schema = articleSchema({
    ...
    url: `https://tianji.love/${locale}/how-to-know-if-my-ex-is-over-me`,
    publishedTime: '2025-06-10T00:00:00Z',
    locale,
  });
