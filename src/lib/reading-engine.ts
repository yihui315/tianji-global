...
export function generateReading(
  ...
  const fallback: Reading = {
    ...
    insights: {
      structure: { hook: '', body: '', closure: '' },
      relationship: { hook: '', body: '', closure: '' },
      career: { hook: '', body: '', closure: '' },
      risk: { hook: '', body: '', closure: '' },
    },
    applications: {
      love: { hook: '', body: '', advice: [] },
      career: { hook: '', body: '', advice: [] },
      wealth: { hook: '', body: '', advice: [] },
    },
